...
const timezones = [
  ...
  "GMT−11 — American Samoa, Niue",
  "GMT−10 — Hawaii (HST)",
  "GMT−9:30 — Marquesas Islands",
  "GMT−9 — Gambier Islands",
  "GMT−8 — Alaska (AKDT, currently); US Pacific in winter (PST)",
  "GMT−7 — US Pacific (PDT, currently) — Los Angeles, Seattle, Vancouver; Arizona (MST, no DST)",
  "GMT−6 — US Mountain (MDT, currently) — Denver, Calgary; Central America (no DST)",
  "GMT−5 — US Central (CDT, currently) — Chicago, Dallas, Mexico City; Colombia, Peru, Ecuador",
  "GMT−4 — US Eastern (EDT, currently) — New York, Toronto, Miami; Venezuela, Caribbean",
  "GMT−3:30 — Newfoundland (NDT, currently)",
  "GMT−3 — Atlantic Canada (ADT, currently); Argentina, Brazil, Uruguay",
  "GMT−2 — South Georgia, Fernando de Noronha",
  "GMT−1 — Cape Verde, Azores",
  "GMT+0 — Iceland, Ghana, Liberia",
  "GMT+1 — UK (BST, currently), Ireland, Portugal; West Africa — Lagos, Casablanca",
  "GMT+2 — Central Europe (CEST, currently) — Paris, Berlin, Rome, Madrid; South Africa, Egypt",
  "GMT+3 — Eastern Europe (EEST, currently) — Athens, Helsinki, Bucharest; Moscow, Nairobi, Riyadh",
  "GMT+3:30 — Iran (IRDT, currently)",
  "GMT+4 — UAE (GST) — Dubai, Abu Dhabi; Oman, Baku, Tbilisi, Mauritius",
  "GMT+4:30 — Afghanistan",
  "GMT+5 — Pakistan (PKT) — Karachi, Islamabad; Uzbekistan, Maldives",
  "GMT+5:30 — India (IST) — Mumbai, Delhi, Bangalore; Sri Lanka",
  "GMT+5:45 — Nepal",
  "GMT+6 — Bangladesh — Dhaka; Bhutan, Kazakhstan",
  "GMT+6:30 — Myanmar, Cocos Islands",
  "GMT+7 — Bangkok, Ho Chi Minh City, Jakarta, Hanoi",
  "GMT+8 — Singapore, Hong Kong, Beijing, Shanghai, Taipei, Kuala Lumpur, Manila, Perth",
  "GMT+9 — Japan (JST) — Tokyo; South Korea (KST) — Seoul",
  "GMT+9:30 — Australia Central (ACST) — Adelaide, Darwin",
  "GMT+10 — Australia East (AEST) — Sydney, Melbourne, Brisbane; Guam",
  "GMT+11 — Solomon Islands, Vanuatu, New Caledonia",
  "GMT+12 — New Zealand (NZST) — Auckland, Wellington; Fiji",
];
